/*form login participate tournament*/
let templateForm = document.getElementById('compFormLogin');
let templateContent = templateForm.content;


const formLogin = "
  <template id='compFormLogin'>
